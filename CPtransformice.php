...
if(!$_SESSION['usuario_email']){
  ...
  header('Location: tpcTransformice.php');
  exit(); 
}
...
$sql = "INSERT INTO postagem (topico_id, usuario_id, post_title, post_text, post_date) VALUES (5,'{$_SESSION['usuario_id']}', '$title', '$text', NOW())";
