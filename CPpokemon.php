...
if(!$_SESSION['usuario_email']){
  ...
  header('Location: tpcPokemon.php');
  exit(); 
}
...
$sql = "INSERT INTO postagem (topico_id, usuario_id, post_title, post_text, post_date) VALUES (2,'{$_SESSION['usuario_id']}', '$title', '$text', NOW())";
